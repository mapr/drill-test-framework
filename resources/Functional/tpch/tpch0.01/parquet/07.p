{
  ...
  "graph" : [ {
    ...
    "@id" : 23,
    "child" : 25,
    "expr" : "booleanAnd(greater_than_or_equal_to(`T42¦¦l_shipdate`, cast( 788918400000 as DATE)) , less_than_or_equal_to(`T42¦¦l_shipdate`, cast( 851990400000 as DATE)) ) ",
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
    "cost" : 6504.0
  }, {
    ...
    "conditions" : [ {
      "relationship" : "==",
      "left" : "`T40¦¦n_nationkey`",
      "right" : "`T41¦¦s_nationkey`"
    } ],
    "joinType" : "INNER",
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
    ...
    "conditions" : [ {
      "relationship" : "==",
      "left" : "`T44¦¦c_nationkey`",
      "right" : "`T45¦¦n_nationkey`"
    } ],
    "joinType" : "INNER",
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
    ...
    "@id" : 7,
    "child" : 8,
    "expr" : "booleanOr(booleanAnd(equal(cast( (`T40¦¦n_name` ) as VARCHAR(5) ), 'EGYPT') , equal(cast( (`T45¦¦n_name` ) as VARCHAR(13) ), 'UNITED STATES') ) , booleanAnd(equal(cast( (`T40¦¦n_name` ) as VARCHAR(13) ), 'UNITED STATES') , equal(cast( (`T45¦¦n_name` ) as VARCHAR(5) ), 'EGYPT') ) ) ",
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
    "cost" : 1626.0
  }, {
    ...
    "exprs" : [ {
      ...
      "ref" : "`l_year`",
      "expr" : "extractYear(`T42¦¦l_shipdate`) "
    }, {
      "ref" : "`volume`",
      "expr" : "multiply(`T42¦¦l_extendedprice`, subtract(1, `T42¦¦l_discount`) ) "
    } ],
    "child" : 6,
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
