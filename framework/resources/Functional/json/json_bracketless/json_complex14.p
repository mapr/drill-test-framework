{
  ...
  "graph" : [ {
    "pop" : "fs-scan",
    "@id" : 2,
    "files" : [ "maprfs:/drill/testdata/json_storage/datasources/complex_student.json" ],
    "storage" : {
      "type" : "file",
      "enabled" : true,
      "connection" : "maprfs:///",
    ...
    "selectionRoot" : "/drill/testdata/json_storage/datasources/complex_student.json",
    "cost" : 2.0
  }, {
    "pop" : "project",
    "@id" : 1,
