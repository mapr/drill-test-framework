{
  ...
  "graph" : [ {
    "pop" : "fs-scan",
    "@id" : 2,
    "files" : [ "maprfs:/drill/testdata/json_storage/datasources/vvtypes.json" ],
    "storage" : {
      "type" : "file",
      "enabled" : true,
      "connection" : "maprfs:///",
    ...
    "selectionRoot" : "/drill/testdata/json_storage/datasources/vvtypes.json",
    "cost" : 3.0
  }, {
    "pop" : "project",
    "@id" : 1,
    "exprs" : [ {
      "ref" : "`EXPR$0`",
      "expr" : "cast( (convert_to(`types`[1].`minor`[0].`valueHolder`, \"JSON\") ) as VARCHAR(30) )"
    } ],
    "child" : 2,
