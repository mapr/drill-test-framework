...
explain plan for select * from (
 select o.int_col, o.bigint_col, o.date_col, o.time_col, o.timestamp_col, o.interval_col, o.varchar_col, o.float_col, o.double_col, o.bool_col,
...
from dfs_test.`cross-sources`.`fewtypes.parquet` p
full outer join hive.hive_native.fewtypes_null_hive o
    ...
    and p.bool_col = o.bool_col) t limit 0;
