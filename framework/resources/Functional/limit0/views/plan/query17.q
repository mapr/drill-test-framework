...
explain plan for select * from (select v17.avgDuration, v17_2.visitDate, v17_2.userAgent from v17 inner join v17_2 on v17.pageURL = v17_2.destinationURL) t limit 0;
drop view v17;
drop view v17_2;
