select distinct dt from (select date_col dt from  dfs_test.`/drill/testdata/parquet_date/metadata_cache/metadata_cache1.2_autogen/fewtypes_null_large`  where date_col is not null
union all 
