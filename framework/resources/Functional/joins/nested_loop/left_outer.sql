...
--@test
select c.custID, c.firstname, o.orderID, o.totalCost from dfs.`/drill/testdata/joins/MD-3686/customer` c left outer join dfs.`/drill/testdata/joins/MD-3686/order` o on c.custID = o.custID;
