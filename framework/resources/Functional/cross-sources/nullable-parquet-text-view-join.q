create or replace view dfs_test.`cross-sources`.fewtypes_null_view2 as
select
...
inner join dfs_test.`cross-sources`.fewtypes_null_view2 o
...
drop view dfs_test.`cross-sources`.fewtypes_null_view2;
