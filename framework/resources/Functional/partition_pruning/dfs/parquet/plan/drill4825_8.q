create or replace view dfs.drillTestDirViews.drill4825_v1 as 
...
explain plan for select count (*) from dfs.drillTestDirViews.drill4825_v1;
drop view dfs.drillTestDirViews.drill4825_v1;
