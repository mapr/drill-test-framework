SELECT (CASE WHEN true THEN res1 ELSE null END) res
FROM
(     
      SELECT
         ...
         (CASE WHEN (false) THEN null ELSE CAST('P1DT12H' AS INTERVAL DAY) END) res10,
         (CASE WHEN (false) THEN null ELSE CAST('P3Y2M1DT12H' AS INTERVAL DAY) END) res11,
