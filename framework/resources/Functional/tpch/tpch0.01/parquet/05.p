{
  ...
  "graph" : [ {
    ...
    "@id" : 22,
    "child" : 25,
    "expr" : "booleanAnd(greater_than_or_equal_to(`T59¦¦o_orderdate`, cast( 852076800000 as DATE)) , less_than(`T59¦¦o_orderdate`, add(cast( 852076800000 as DATE), cast( 'P12M' as INTERVALYEAR)) ) ) ",
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
    "cost" : 1100.75
  }, {
    ...
    "@id" : 17,
    "child" : 21,
    "expr" : "equal(cast( (`T56¦¦r_name` ) as VARCHAR(6) ), 'EUROPE') ",
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
    "cost" : 0.15
  }, {
    ...
    "conditions" : [ {
      "relationship" : "==",
      "left" : "`T56¦¦r_regionkey`",
      "right" : "`T57¦¦n_regionkey`"
    } ],
    "joinType" : "INNER",
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
    ...
    "conditions" : [ {
      "relationship" : "==",
      "left" : "`T58¦¦c_nationkey`",
      "right" : "`T61¦¦s_nationkey`"
    }, {
      "relationship" : "==",
      "left" : "`T60¦¦l_suppkey`",
      "right" : "`T61¦¦s_suppkey`"
    ...
    "exprs" : [ {
      ...
      "ref" : "`$f1`",
      "expr" : "multiply(`T60¦¦l_extendedprice`, subtract(1, `T60¦¦l_discount`) ) "
    } ],
    "child" : 6,
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
