{
  ...
  "graph" : [ {
    ...
    "exprs" : [ {
      "ref" : "`$f0`",
      "expr" : "multiply(cast( (`columns`[5] ) as FLOAT8 ), cast( (`columns`[6] ) as FLOAT8 )) "
    } ],
    "child" : 3,
    "initialAllocation" : 1000000,
    "maxAllocation" : 10000000000,
