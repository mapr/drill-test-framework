...
then
  ${DRILL_HOME}/bin/sqlline -u "jdbc:drill:schema=dfs.union_all;drillbit=${DRILL_STORAGE_PLUGIN_SERVER};auth=maprsasl"  --run=${DRILL_TEST_DATA_DIR}/Datasources/limit0/union_all/create_union_all_views.sql
elif [ -z "$PASSWORD" ]
then
