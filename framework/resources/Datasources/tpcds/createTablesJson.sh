...
${DRILL_HOME}/bin/sqlline -n root -p mapr -u "jdbc:drill:schema=dfs.tpcds_sf1_json;drillbit=${DRILL_STORAGE_PLUGIN_SERVER}"  --run=resources/Datasources/tpcds/createTablesJson.sql
