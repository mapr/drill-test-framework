use dfs_test.tpcds_sf1_json_views;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/customer`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/customer_address`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/customer_demographics`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/household_demographics`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/promotion`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/time_dim`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/date_dim`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/store`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/store_sales`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/warehouse`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/ship_mode`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/reason`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/income_band`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/call_center`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/web_site`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/store_returns`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/catalog_page`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/inventory`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/web_sales`;
...
from dfs_test.`/drill/testdata/tpcds_sf1/json/catalog_sales`;
