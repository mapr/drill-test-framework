create database if not exists tpcds01_text;
drop table if exists tpcds01_text.customer;
create external table tpcds01_text.customer 
(
    c_customer_sk int,
...
create external table tpcds01_text.customer_address 
(
    ca_address_sk int,
...
drop table if exists tpcds01_text.customer_demographics;
create external table tpcds01_text.customer_demographics 
(
    cd_demo_sk int,
    cd_gender string,
...
create external table tpcds01_text.household_demographics 
(
    hd_demo_sk int,
...
drop table if exists tpcds01_text.item;
create external table tpcds01_text.item 
(
    i_item_sk int,
    i_item_id string,
...
drop table if exists tpcds01_text.promotion;
create external table tpcds01_text.promotion 
(
    p_promo_sk int,
    p_promo_id string,
    p_start_date_sk int,
...
create external table tpcds01_text.time_dim (
    t_time_sk int, 
    t_time_id string, 
    t_time int, 
    t_hour int, 
...
create external table tpcds01_text.date_dim (
    d_date_sk int, 
    d_date_id string, 
    d_date date, 
    d_month_seq int, 
...
create external table tpcds01_text.store ( 
    s_store_sk int, 
    s_store_id string, 
...
create external table tpcds01_text.store_sales ( 
    ss_sold_date_sk int, 
    ss_sold_time_sk int, 
    ss_item_sk int, 
    ss_customer_sk int, 
...
create external table tpcds01_text.warehouse ( 
    w_warehouse_sk int,
...
create external table tpcds01_text.ship_mode (
    sm_ship_mode_sk int,
...
create external table tpcds01_text.reason (
    r_reason_sk int,
    r_reason_id string,
...
create external table tpcds01_text.income_band ( 
...
create external table tpcds01_text.call_center ( 
...
create external table tpcds01_text.web_site (  
    web_site_sk int,
    web_site_id string,
...
create external table tpcds01_text.store_returns ( 
...
create external table tpcds01_text.web_page ( 
    wp_web_page_sk int,
...
create external table tpcds01_text.catalog_page (
...
create external table tpcds01_text.inventory ( 
    inv_date_sk int,
    inv_item_sk int,
...
create external table tpcds01_text.catalog_returns ( 
...
create external table tpcds01_text.web_returns ( 
...
create external table tpcds01_text.web_sales (
    ws_sold_date_sk int,
    ws_sold_time_sk int,
    ws_ship_date_sk int,
    ws_item_sk int,
...
create external table tpcds01_text.catalog_sales ( 
    cs_sold_date_sk int,
    cs_sold_time_sk int,
    cs_ship_date_sk int,
