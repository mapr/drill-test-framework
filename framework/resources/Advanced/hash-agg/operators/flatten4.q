-- 1st Agg : No spilling in any of the 16 partitions
-- 2nd Agg : 2 out of 16 partitions spilled and spill cycle is 2
alter session set `planner.width.max_per_node` = 2;
alter session set `planner.width.max_per_query` = 2;
alter session set `planner.memory.max_query_memory_per_node` = 2504857600;
