-- 1st Agg : 2 out of 2 partitions spilled and spill cycle is 2
-- 2nd Agg : 4 out of 4 partitions spilled and spill cycle is 2
alter session set `planner.width.max_per_node` = 5;
alter session set `planner.width.max_per_query` = 5;
alter session set `planner.memory.max_query_memory_per_node` = 1504857600;
